...
# Isabel data bp2 #
load("/home/kai/consult/data/isabel-demodata.Rdata") # bp2 table
load("/home/kai/consult/data/isabel-daily-hr.Rdata") # daily.hr table
risk.evidence<-read.csv("/home/kai/consult/data/isabel-secondary-stroke-intervention-risks.csv") # for cates plot
